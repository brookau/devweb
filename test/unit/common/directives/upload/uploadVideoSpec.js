define(function (require) {
  ...
  var angular = require('angular'),
    ...
    ctrl = require('app/common/directives/upload/controllers/uploadVideoModalController'),
  ...
  describe('Upload text modal', function () {
    ...
    beforeEach(module('ernr.directives.upload', function ($provide, $controllerProvider) {
      $controllerProvider.register('uploadVideoModalController', ctrl);
    }));
    ...
    beforeEach(inject(function (_$compile_, _$rootScope_, $controller) {
      ...
      // create controller
      controller = $controller('uploadVideoModalController', {$scope: $scope, $modalInstance: modalInstance});
      $scope.$digest();
    }));
